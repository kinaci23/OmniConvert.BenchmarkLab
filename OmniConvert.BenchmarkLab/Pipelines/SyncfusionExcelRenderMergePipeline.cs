...
{
    public string Name => "SyncfusionExcelRenderMergePipeline";
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            using FileStream inputStream = new FileStream(request.InputPath, FileMode.Open, FileAccess.Read, FileShare.Read);
            ...
            {
                throw new InvalidOperationException("Syncfusion hiçbir worksheet render edemedi.");
            }
